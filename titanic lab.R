...
titanic_rpart <- rpart(Survived ~ Class+ Age + Sex, data = Titanic)
...
treesurvived<-ctree(Survived ~ Age + Class + Sex, data = Titanic)

cforest(Survived ~ Age + Class + Sex, data = Titanic, controls=cforest_control(mtry=2, mincriterion=0))
